...
func FormatPipelineURL(pipelinerun string, namespace string, logger logr.Logger) string {
	...
	// #nosec G708 -- CONSOLE_URL is a trusted admin-controlled environment variable set during deployment
...
func FormatTaskLogURL(taskRun *helpers.TaskRun, pipelinerun string, namespace string, logger logr.Logger) string {
	...
	// #nosec G708 -- CONSOLE_URL_TASKLOG is a trusted admin-controlled environment variable set during deployment
